...
public class MatchInput {
    ...
    public MatchInput(String id, String city, String date, String season, String matchNumber, String team1,
            String team2, String venue, String tossWinner, String tossDecision, String superOver, String winningTeam,
            String wonBy, String margin, String method, String playerOfMatch, String team1Players,
            String team2Players, String umpire1, String umpire2) {
        this.id = id;
        this.city = city;
        this.date = date;
        this.season = season;
